<%@ Page Title="Courses" Language="C#" MasterPageFile="~/SiteAnon.Master" AutoEventWireup="true" CodeBehind="Courses.aspx.cs" Inherits="GestureHub.Course" %>
            ...
            <div class="card mt-3" data-mdb-ripple-color="light" style="width: 20rem;">
                ...
                <div class="card-body">
                   ...
                   <div class="row justify-content-around">
                        ...
                        <a href="/Member/TakeQuiz.aspx" class="btn btn-secondary align-items-center col-5">TAKE QUIZ</a>
                    </div> 
                </div>
            </div>
